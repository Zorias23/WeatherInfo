...
import com.example.admin.weatherinfo.model.CurrentWeather.DisplayLocation;
...
import com.example.admin.weatherinfo.util.CardRecycleAdapter;
import com.example.admin.weatherinfo.view.main.MainPresenter;
import com.example.admin.weatherinfo.view.main.MainContract;
import com.example.admin.weatherinfo.view.main.MainPresenter;
...
public class MainActivity extends AppCompatActivity implements MainContract.View
{
    ...
    private void requestZip()
    {
        if (zip.equals(""))
        {
            ...
            alert.setTitle("Enter a zipcode for your weather forecast");
    ...
    @Override
    public void setCurrentWeather(CurrentWeatherResponse weatherResponse)
    {
