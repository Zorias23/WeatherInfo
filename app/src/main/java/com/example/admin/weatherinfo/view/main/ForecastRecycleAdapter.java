...
import com.example.admin.weatherinfo.model.HourlyWeather.FCTTIME;
import com.example.admin.weatherinfo.model.HourlyWeather.HourlyForecast;

import java.util.ArrayList;
import java.util.List;

import static com.example.admin.weatherinfo.R.*;
...
public class ForecastRecycleAdapter extends RecyclerView.Adapter<ForecastRecycleAdapter.ViewHolder>
{
    ...
    private void setConditionImage(ViewHolder holder, HourlyForecast forecast)
    {
        ...
        {
            holder.ivCondition.setImageResource(drawable.weather_snow);
        }
        ...
        {
            holder.ivCondition.setImageResource(drawable.weather_partly_cloudly);
        }
